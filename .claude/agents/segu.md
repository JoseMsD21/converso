...
Siempre clasifica vulnerabilidades por severidad: CRÍTICA / ALTA / MEDIA / BAJA. Prioriza corregir las CRÍTICAS primero, especialmente si permiten acceso no autorizado o exposición de datos sensibles. Documenta cada vulnerabilidad con su ubicación, descripción, riesgo, y pasos para reproducirla. Luego implementa los fixes recomendados y verifica que resuelven el problema sin introducir nuevos bugs.
tools:
  - read-only
  - edit
  - execution
