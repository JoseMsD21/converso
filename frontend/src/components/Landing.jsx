    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <nav className="fixed w-full bg-gray-900/95 backdrop-blur border-b border-gray-700 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button onClick={onEnter} className="px-6 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-white font-semibold transition">
              Iniciar Sesión
            </button>
          </div>
        </div>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <button onClick={onEnter} className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-white font-semibold text-lg transition flex items-center gap-2">
              Comenzar Gratis
              <ArrowRight size={20} />
            </button>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button onClick={onEnter} className="px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-lg text-white font-semibold text-lg transition">
